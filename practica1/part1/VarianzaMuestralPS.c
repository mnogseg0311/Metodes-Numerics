//Programa que calcula, en simple precisión, la varianza muestral de n números determinados
#include <stdio.h>
#include <math.h>

int main() {
    int n = 3; 				//Número de elementos de los que queremos calcular la varianza muestral
    float x[] = {10000,10001,10002}; 	//Elementos de los que queremos calcular la varianza muestral
