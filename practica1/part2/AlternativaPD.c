//Programa que calcula, en doble precisión, menos dos veces el sumatorio alternado de los inversos de los naturales al cuadrado.
...
int main() {
    ...
    double sn = 0;       //Vairable, en simple precisión, en la que vamos guardando las sumas parciales
    double a = n;        //Variable auxiliar
